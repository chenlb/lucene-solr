...
public class ProtobufSolrTestCaseJ4 extends SolrTestCaseJ4 {

  private static final Logger logger = LoggerFactory
      .getLogger(ProtobufSolrTestCaseJ4.class);

  protected static class QueryReqestGetter implements RequestGetter {
  ...
  protected static class UpdateRequestGetter implements RequestGetter {
  ...
  protected static class MemResponseSetter extends ProtobufResponseSetter {
