...
public class NettySolrException extends SolrException {
  ...
  public NettySolrException (ErrorCode errorCode, String msg) {
    super(errorCode.code, msg, null);
  }

  public NettySolrException (VootooErrorCode errorCode, String msg) {
    super(errorCode.code, msg, null);
  }

  public NettySolrException (ErrorCode errorCode, String msg, Throwable th) {
    super(errorCode.code, msg, th);
  }

  public NettySolrException (VootooErrorCode errorCode, Throwable th) {
