...
public class ProtobufUtil {
    ...
    return Lists.transform(Lists.newArrayList(contentStreams),
        new Function<ContentStream,SolrProtocol.ContentStream>() {
          ...
          public SolrProtocol.ContentStream apply (ContentStream input) {
            SolrProtocol.ContentStream.Builder stream = SolrProtocol.ContentStream
                .newBuilder();
            ...
            try {
              ...
              throw new RuntimeException("ContentStream.getStream() exception",
                  e);
            }
  ...
  public static String getResponseBodyCharset(SolrProtocol.SolrResponse protocolResponse) {
    ...
    if(protocolResponse != null) {
      ...
      if(responseBody != null) {
        charset = ContentStreamBase
            .getCharsetFromContentType(responseBody.getContentType());
      }
    }
    return charset;
  }
   ...
   */
  public static NettySolrException toVootooException(SolrProtocol.ExceptionBody exceptionBody) {
    String msg = exceptionBody.getMessage();
    NettySolrException.VootooErrorCode vec = NettySolrException.VootooErrorCode.getErrorCode(exceptionBody.getCode());
    NettySolrException ve = new NettySolrException(vec, msg);
    if(vec == NettySolrException.VootooErrorCode.UNKNOWN) {
